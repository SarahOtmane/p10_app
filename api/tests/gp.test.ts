...
describe('gpResolvers', () => {
    describe('Query', () => {
        it('getAllGPs returns all GPs', async () => {
            (GP.findAll as unknown as unknown as jest.Mock).mockResolvedValue([mockGP]);
        ...
        it('getGPById returns GP by id', async () => {
            (GP.findByPk as unknown as unknown as jest.Mock).mockResolvedValue(mockGP);
        ...
        it('getGPById throws error if GP not found', async () => {
            (GP.findByPk as unknown as unknown as jest.Mock).mockResolvedValue(null);
            await expect(
    ...
    describe('Mutation', () => {
        describe('importGPsAndTracks', () => {
            ...
            it('throws error if user not authenticated', async () => {
                (requireAdmin as unknown as unknown as jest.Mock).mockReturnValue({});
                await expect(
            ...
            it('imports GPs and tracks', async () => {
                ...
                (Tracks.findOne as unknown as unknown as jest.Mock).mockResolvedValue(null);
                (Tracks.create as unknown as unknown as jest.Mock).mockResolvedValue(mockTrack);
                (GP.findByPk as unknown as unknown as jest.Mock).mockResolvedValue(null);
                (GP.create as unknown as unknown as jest.Mock).mockResolvedValue({});
            ...
            it('skips existing tracks and GPs', async () => {
                ...
                (Tracks.findOne as unknown as unknown as jest.Mock).mockResolvedValue(mockTrack);
                (GP.findByPk as unknown as unknown as jest.Mock).mockResolvedValue(true);
        ...
        describe('updateGP', () => {
            ...
            it('updates GP and returns updated GP', async () => {
                ...
                (GP.findByPk as unknown as unknown as jest.Mock).mockResolvedValue(gpInstance);
